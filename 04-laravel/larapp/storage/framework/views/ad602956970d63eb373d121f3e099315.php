        ...
        <ul>
            <li>
                <a href="<?php echo e(url('users')); ?>">
                    <img src="<?php echo e(asset('image/ico-users.svg')); ?>" alt="Users">
                    <span>Module User</span>    
                </a>
            </li>
            <li>
                <a href="<?php echo e(url('pets')); ?>">
                    <img src="<?php echo e(asset('image/ico-pets.svg')); ?>" alt="Pets">
                    <span>Module Pets</span>
                </a>
            </li>
            <li>
                <a href="<?php echo e(url('adoptions')); ?>">
                    <img src="<?php echo e(asset('image/ico-adopt.svg')); ?>" alt="Adoptions">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\AUTOCAD\Desktop\tcods2770672\04-laravel\larapp\resources\views/dashboard-admin.blade.php ENDPATH**/ ?>